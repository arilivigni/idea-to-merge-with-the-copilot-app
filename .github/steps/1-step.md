...
1. Install the **GitHub Copilot App** and sign in. Download it from **https://github.com/features/ai/github-app**, then choose the download for your platform (macOS, Windows, or Linux).
